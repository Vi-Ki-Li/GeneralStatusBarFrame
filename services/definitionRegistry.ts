...
export const DEFAULT_ITEM_DEFINITIONS: ItemDefinition[] = [
  ...
  { key: '特征', name: '特征', type: 'array', defaultCategory: 'CP', separator: '@', icon: 'Sparkles', structure: { parts: ['trait'] } },
  { key: '永久性状态', name: '永久性状态', type: 'array', defaultCategory: 'CP', separator: '@', icon: 'AlertOctagon', structure: { parts: ['state'] } },
  ...
  { 
    ...
    separator: '|', structure: { parts: ['current', 'change', 'reason'], labels: ['金额', '变化', '原因'] }
  },
  { 
  ...
  { 
    ...
    separator: '|', structure: { parts: ['current', 'max', 'change', 'reason', 'description'], labels: ['当前', '最大', '变化', '原因', '描述'] }
  },
  { 
  ...
  // --- RP: 关系 (结构同上) ---
  { key: '好感度', name: '好感度', type: 'numeric', defaultCategory: 'RP', icon: 'Heart', separator: '|', structure: { parts: ['current', 'max', 'change', 'reason', 'description'], labels: ['当前', '最大', '变化', '原因', '描述'] } },
  { key: '信任度', name: '信任度', type: 'numeric', defaultCategory: 'RP', icon: 'ShieldCheck', separator: '|', structure: { parts: ['current', 'max', 'change', 'reason', 'description'], labels: ['当前', '最大', '变化', '原因', '描述'] } },
  { key: '堕落度', name: '堕落度', type: 'numeric', defaultCategory: 'RP', icon: 'Skull', separator: '|', structure: { parts: ['current', 'max', 'change', 'reason', 'description'], labels: ['当前', '最大', '变化', '原因', '描述'] } },
  { key: '支配度', name: '支配度', type: 'numeric', defaultCategory: 'RP', icon: 'Gavel', separator: '|', structure: { parts: ['current', 'max', 'change', 'reason', 'description'], labels: ['当前', '最大', '变化', '原因', '描述'] } },
  { key: '依赖度', name: '依赖度', type: 'numeric', defaultCategory: 'RP', icon: 'Link', separator: '|', structure: { parts: ['current', 'max', 'change', 'reason', 'description'], labels: ['当前', '最大', '变化', '原因', '描述'] } },
  { key: '羞耻度', name: '羞耻度', type: 'numeric', defaultCategory: 'RP', icon: 'EyeOff', separator: '|', structure: { parts: ['current', 'max', 'change', 'reason', 'description'], labels: ['当前', '最大', '变化', '原因', '描述'] } },
  { key: '服从度', name: '服从度', type: 'numeric', defaultCategory: 'RP', icon: 'Dog', separator: '|', structure: { parts: ['current', 'max', 'change', 'reason', 'description'], labels: ['当前', '最大', '变化', '原因', '描述'] } },
  { key: '声誉', name: '声誉', type: 'numeric', defaultCategory: 'RP', icon: 'Star', separator: '|', structure: { parts: ['current', 'max', 'change', 'reason', 'description'], labels: ['当前', '最大', '变化', '原因', '描述'] } },
  ...
  // --- WP: 世界剧情 (列表类) ---
  { key: '当前npc', name: '当前NPC', type: 'array', defaultCategory: 'WP', separator: '|', icon: 'Users', structure: { parts: ['npc_info'] } },
  { key: '剧情发展', name: '剧情发展', type: 'array', defaultCategory: 'WP', separator: '|', icon: 'TrendingUp', structure: { parts: ['option'] } },
